...
CASES = [
    case(
        ...
        "Pharrell Williams: Son of a Pharoah",
        "JOOPITER",
    ...
    case(
        ...
        "Google Pixel 3 x Childish Gambino Activation",
        "Google · MAS",
    ...
    case(
        ...
        ["For this project, I managed and produced Youtube Music’s partnership elements for Rolling Stone’s relaunch event featuring a live performance from Shawn Mendes.",
         "Leading comms across two brand teams and multiple agency partners on co-branded concepts. I also led the collaboration between the MAS creative team and multiple vendors to develop and activate two interactive product demos for the DSP.",
    ...
    case(
        ...
        "YouTube Music x Megan Thee Stallion",
        "YouTube Music · MAS",
    ...
    case(
        ...
        "YouTube Grammy Party NYC",
        "YouTube · MAS",
        ["Celebrating the Grammy’s return to New York, YouTube threw a party hosted by Lyor Cohen. The night featured performances by Nas, Grandmaster Flash, D-Nice, & Vashtie. Other notable guests included Quincy Jones, Diplo, Camila Cabello, Jared Leto, Lala, Terrence J, and more. This event was designed and produced by MAS Event + Design."],
        "Project Contributions",
    ...
    case(
        ...
        "Google Mixtape",
        "Google · MAS",
        ["To provide a surprise and delight moment during Advertising Week, Google invited over 2000 guests to pull away from their screens by shipping a personalized “Mixtape” experience to pair with the brand’s audio-first content developed specifically for the advertising industry’s top virtual event.",
...
ABOUT = {
    ...
    "blocks": [
        ...
        {"type": "p",
         "text": "I’ve spent over 20 years at the forefront of culture as a DJ, sneakerhead, and dot connector. Combine that with over ten years of working with the most well-known brands in the world. I bring a creative director’s vision, a music supervisor’s ear, and a producer’s type-A structure to every project."},
...
RESUME = {
    ...
    "blocks": [
        ...
        {"type": "cells", "items": [
            ...
            "Absolut", "Pepsi Co. & Mountain Dew", "Monster Energy",
            "Jack Daniels", "Hypebeast"]},
